...
setup(
    name='topology_lib_subinterface',
    version=find_version('lib/topology_lib_subinterface/__init__.py'),
    package_dir={'': 'lib'},
    ...
    author_email='payal.upadhyaya@hpe.com',
    description=(
    ...
    entry_points={
        'topology_library_10': [
            'subinterface = topology_lib_subinterface.library'
        ]
    }
)
